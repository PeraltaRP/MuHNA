            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              if (snapshot.data == null) {
                ...
                for (int i = 0; i < snapshot.data.length; i++) {
                  if (snapshot.data[i].contains("jpeg") ||
                      snapshot.data[i].contains("jpg") ||
                      snapshot.data[i].contains("png") ||
                      snapshot.data[i].contains("webp")) {
                    imagem_inicial = i;
                    break;
                  }
                  for (int i = 0; i < snapshot.data.length; i++) {
                    if (snapshot.data[i].contains("mp3") ||
                        snapshot.data[i].contains("mp4")) {
                      video_inicial = i;
                    }
                  }
                }
                  ...
                  return SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(snapshot.data[0], style: TextStyles.tituloqrcode),
                        SizedBox(
                          child: Image.network(
                            snapshot.data[imagem_inicial].toString(),
                            // width: size.width * 1,
